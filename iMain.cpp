...
void iDraw(){
	...
	if(gameState == 0){
		...
		// Get the sorted sequence of objects from DrawManager
...
//collision 
//(horizontalDistance(player1.pivotX,player2.pivotX) > ((player1.width/2) + (player2.width/2))) || (verticalDistance(player1.pivotY,player2.pivotY) > ((player1.height/2) + (player2.height/2)))
